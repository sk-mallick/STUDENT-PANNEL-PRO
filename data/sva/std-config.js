...
export default {
    ...
    // ── Identity ────────────────────────────────────────────────
    id: 'sva',          // must match folder name
    order: 2,                 // sort order on dashboard (01, 02, 03…)
    title: 'SVA',
    description: '',
    icon: 'book',           // key from SUBJECT_ICONS in app.js
    ...
    levels: {
        ...
        primary: {
            ...
            videoTitle: 'Primary Subject-Verb Agreement Course'
        },
        ...
        middle: {
            ...
            order: 3,
            playlistId: null,
            videoTitle: 'Middle School Subject-Verb Agreement Course'
        },
        ...
        high: {
            ...
            order: 4,
            playlistId: null,
            videoTitle: 'Advanced Subject-Verb Agreement Course'
        }
    },
    ...
    pdfs: {
        primary: './pdfs/sva/primary/',
        middle: './pdfs/sva/middle/',
        high: './pdfs/sva/high/'
    }
};